...
```{r}
#how do I fix the x values so they go day by day but are still integers... a way other than Julian Day?
```
...
m1 <- lm(Percentage_Female_Gonads~Water_Temps_at_1m, Pacific_Oyster_Sex_Ratio)
summary(m1)
m1.binomial <- glm(Percentage_Female_Gonads~Water_Temps_at_1m, 
                   family = "binomial",
                   data = Pacific_Oyster_Sex_Ratio)
summary(m1.binomial)
m2.binomial <- glm(Percentage_Female_Gonads~Water_Temps_at_1m+Total_Plankton, 
                   family = "binomial",
                   data = Pacific_Oyster_Sex_Ratio)
summary(m2.binomial)
