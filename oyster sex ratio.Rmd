...
long_barplot <- gather(data = barplotdata_2, key = "day", value = "count", 1:6) # key = description for columns you have & value = description for what is in the cells of your data frame
long_barplot

# change date to be factor
long_barplot$day <- factor(long_barplot$day, levels = c("6/6", "6/13", "6/20", "6/26", "7/5", "7/11"))
